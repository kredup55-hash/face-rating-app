...
"ПЛАН НА 30 ДНЕЙ:\n- НЕДЕЛЯ 1: [конкретное действие на первую неделю]\n- НЕДЕЛЯ 2: [конкретное действие на вторую неделю]\n- НЕДЕЛЯ 3: [конкретное действие на третью неделю]\n- НЕДЕЛЯ 4: [конкретное действие на четвертую неделю]\n"
